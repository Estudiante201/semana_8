										...
										<tbody>
												...
												<c:forEach items="${alumnos}" var="x">
													<tr>
														...
														<td>${x.dni}</td>
														<td>${x.correo}</td>
														<td><fmt:formatDate value="${x.fechaNacimiento}"  type="date" pattern="yyyy-MM-dd"/></td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idAlumno}','${x.nombre}','${x.dni}','${x.correo}','<fmt:formatDate value="${x.fechaNacimiento}"  type="date" pattern="yyyy-MM-dd"/>');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_dni" name="dni" placeholder="Ingrese el dni" type="text">
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_pdni" name="dni" placeholder="Ingrese el dni" type="text">
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_fechaNacmiento">Fecha Nacimiento</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_fechaNacmiento" name="fechaNacmiento" type="date">
		                                        </div>
		                                    </div>  
		                                    <div class="form-group">
		                                        <div class="col-lg-9 col-lg-offset-3">
